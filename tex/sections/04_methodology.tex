...
La disponibilidad del MEPCO permite contrastarla de manera directa. La \Cref{hip:margen} formula la misma predicción a partir de la \Cref{prop:margen}. Para contrastarla hace falta una medida del margen con que cada estación operaba antes de la entrada, y esa medida debe cumplir dos condiciones.
...
en cada combustible, con ponderadores iguales a la participación de cada uno en
el volumen nacional de ventas —$19{,}6\%$ la gasolina de 93 octanos, $11{,}9\%$
la de 95, $4{,}0\%$ la de 97 y $64{,}4\%$ el diésel, según
\textcite{FNE2025informe}— y \emph{excluyendo el combustible que se analiza en
cada caso}. Al estimar el efecto sobre el precio del diésel, por ejemplo, el
